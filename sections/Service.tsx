...
const Service: React.FC = () => {
    const cards = [
        ...
        {
            title: "Backend",
            text: "Есть небольшой опыт разработки бекенда на уровне: авторизация/регистрация пользователя, взаимодействие с БД (MongoDB) с помощью http запросов, отправка данных через сookie и т.д."
        },
        {
            title: "Fullstack",
            text: "Готов взяться за fullstack проект под ключ, честно оценив свои силы и возможности. Также владею навыками сборки, настройки и развёртывания приложений на Ubuntu."
        },
        {
            title: "Graphics",
