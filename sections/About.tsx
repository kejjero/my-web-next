                ...
                <motion.div className={s.about__top}>
                    ...
                    <div className={s.about__wrapper_about}>
                        ...
                        <motion.p custom={4} variants={topRightAnimation} className={s.about__paragraph}>
                            Чаще всего я работаю с уклоном на frontend в стеках React / Vue и с сопутствующим
                            к ним библиотекам. Со всей страстью подхожу к изучению неизвестных мне технологий,
